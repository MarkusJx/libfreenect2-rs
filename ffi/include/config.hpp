...
namespace libfreenect2_ffi {
    ...
    public:
        ...
        LIBFREENECT2_MAYBE_UNUSED void set_enable_bilateral_filter(bool enable_bilateral_filter) noexcept;

        LIBFREENECT2_MAYBE_UNUSED void set_enable_edge_aware_filter(bool enable_edge_aware_filter) noexcept;
