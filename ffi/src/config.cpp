...
LIBFREENECT2_MAYBE_UNUSED bool Config::get_enable_bilateral_filter() const noexcept {
    return config.EnableBilateralFilter;
}

LIBFREENECT2_MAYBE_UNUSED bool Config::get_enable_edge_aware_filter() const noexcept {
...
LIBFREENECT2_MAYBE_UNUSED void Config::set_enable_bilateral_filter(bool enable_bilateral_filter) noexcept {
    config.EnableBilateralFilter = enable_bilateral_filter;
}

LIBFREENECT2_MAYBE_UNUSED void Config::set_enable_edge_aware_filter(bool enable_edge_aware_filter) noexcept {
    config.EnableEdgeAwareFilter = enable_edge_aware_filter;
}

LIBFREENECT2_MAYBE_UNUSED std::unique_ptr<Config> libfreenect2_ffi::create_config() {
