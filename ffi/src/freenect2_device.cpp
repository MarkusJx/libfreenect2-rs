...
Freenect2Device::Freenect2Device(libfreenect2::Freenect2Device *device) : device(device) {
    if (device == nullptr) {
...
LIBFREENECT2_MAYBE_UNUSED bool Freenect2Device::start_streams(bool rgb, bool depth) {
...
LIBFREENECT2_MAYBE_UNUSED void Freenect2Device::set_color_frame_listener(const std::unique_ptr<libfreenect2::FrameListener>& listener) {
    device->setColorFrameListener(listener.get());
}

LIBFREENECT2_MAYBE_UNUSED void Freenect2Device::set_ir_and_depth_frame_listener(const std::unique_ptr<libfreenect2::FrameListener> &listener) {
    device->setIrAndDepthFrameListener(listener.get());
}

LIBFREENECT2_MAYBE_UNUSED void Freenect2Device::set_config(const std::unique_ptr<Config> &config) {
